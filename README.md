...
🎓 B.Tech. (Hons.) (CSE - Data Science and Data Engineering) Student at Lovely Professional University  
🚀 Aspiring Data Scientist | ML Enthusiast | Turning Data into Insights  
...
* ⚠️ **Risk Behavior Analysis**  
  ...
  **Tech Stack:** Python, Pandas, ML, Power BI, Power Query, Excel  
  [GitHub](https://github.com/adityakumarsingh01/RISK-BEHAVIOR-ANALYSIS.git) | [LinkedIn](https://www.linkedin.com/posts/aditya-kumar-singh-990377291_datascience-machinelearning-powerbi-activity-7350599179141853185-Jys3?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEa2H7wB3GZS-pnk6rWTCs78bg-tTWNujUk)

* 🔊 **NYC 311 Noise Dashboard**  
  Built an interactive Power BI dashboard to analyze noise complaints and urban patterns in NYC.  
  **Tech Stack:** Power BI, Power Query, Excel  
  [GitHub](https://github.com/adityakumarsingh01/NYC-311-Noise-Dashboard.git) | [LinkedIn](https://www.linkedin.com/posts/aditya-kumar-singh-990377291_powerbi-dashboarddesign-opendata-activity-7347149554619752448-VG1D?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEa2H7wB3GZS-pnk6rWTCs78bg-tTWNujUk)

* 📊 **Adventure Works Sales Analysis**  
  Developed a sales analytics dashboard to track performance, revenue trends, and business insights.  
  **Tech Stack:** Power BI, Power Query, Excel   
  [GitHub](https://github.com/adityakumarsingh01/Adventure-Works-Sales-Analysis.git) | [LinkedIn](https://www.linkedin.com/posts/aditya-kumar-singh-990377291_powerbi-dashboarddesign-businessintelligence-activity-7346097284444471296-ZsWC?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEa2H7wB3GZS-pnk6rWTCs78bg-tTWNujUk)
